...
CDirectives=LA WL(1) CD OT(9, size) NOAREGS OR MODDP2 INCDIR(..\Code\CORE\INCLUDE\;..\Code\OEM\INCLUDE\;..\Code\CHIP\INCLUDE\)
CDirectives1=LA WL(1) CD OT(9, size) NOAREGS OR SRC  MODDP2 INCDIR(..\Code\CORE\INCLUDE\;..\Code\OEM\INCLUDE\;..\Code\CHIP\INCLUDE\)
CDirectives2=LA WL(1) CD OT(8, size) NOAREGS OR  MODDP2 INCDIR(..\Code\CORE\INCLUDE\;..\Code\OEM\INCLUDE\;..\Code\CHIP\INCLUDE\)
